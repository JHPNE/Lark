...
namespace DrosimEditor.SimProject
{
    ...
    class OpenProject    
    {
        private static readonly string _applicationDataPath = $@"{Environment.GetFolderPath(Environment.SpecialFolder.ApplicationData)}\DrosimEditor\";
        ...
        private static void ReadProjectData()
        {
            ...
            if (File.Exists(_projectDataPath))
            {
                ...
                foreach (var project in projects) 
                {
                    ...
                    {
                        project.Icon = File.ReadAllBytes($@"{project.ProjectPath}\.Drosim\Icon.png");
                        project.Screenshot = File.ReadAllBytes($@"{project.ProjectPath}\.Drosim\Screenshot.png");
