...
TEST_F(MultirotorTest, StepTestHummingbird)
{
    ...
    Vector4f expected_attitude{-0.002022944724344893, 0.001813244200240739, -0.0005004203071620471,
    0.9999961847025362};  // Quaternion [x,y,z,w] Vector3f expected_body_rates{-0.8692547060514457,
    0.7704085190757337, -0.22636673873388363}; // w Vector3f expected_wind{0.06279051952931337,
    0.06279051952931337, 0.06279051952931337}; Vector4f expected_rotor_speeds{242.1086173485404,
    968.3892283485751, 696.7811089428872, 951.0528204785043};
    */
    // eigen integration
