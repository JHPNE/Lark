...
namespace lark::drones::test {
    ...
    TEST_F(ControllerTest, ControllerOutputVerificationHummingbird) {
        ...
        // Note: cmd_motor_speeds and cmd_motor_thrusts are not directly returned by computeMotorCommands
        // They would need to be computed or exposed through the controller if needed
