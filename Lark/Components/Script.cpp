...
bool exists(script_id id)
{
    ...
    assert(index < generations.size() &&
           !(id::is_valid(id_mapping[index]) && id_mapping[index] >= entity_scripts.size()));
...
script_registry &get_script_registry() { return lark::script::registry(); }

bool script_exists(size_t tag) { return lark::script::registry().find(tag) != registry().end(); }
